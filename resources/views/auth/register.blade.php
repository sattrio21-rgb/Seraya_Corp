...
<head>
    ...
    <title>Register - Seraya Travel</title>
    ...
    <div class="w-full max-w-md p-8">
        <div class="bg-white rounded-2xl shadow-lg p-8">
            ...
            <div class="text-center mb-8">
                ...
                <h1 class="text-2xl font-bold text-gray-800 mt-4">Buat Akun Baru</h1>
                <p class="text-gray-500 text-sm mt-1">Daftar untuk mulai booking</p>
            </div>
